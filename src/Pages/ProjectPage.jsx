                        ...
                        <div className="row help align-items-center">
                            <div className="col-lg-6 col-md-6">
                                <div className="help-thumb">
                                    <img
                                        src="https://images.unsplash.com/photo-1556761175-b413da4baf72?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHRlYW0lMjBiYW5uZXJ8ZW58MHx8MHx8fDA%3D"
                                        alt="help-thumb"
                                    />
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6">
                                <div className="section-title text-left">
                                    ...
                                    <p className="section-title-desc">
                                        Discover the culmination of expertise and dedication at S M
                                        Service Consultancy. From pioneering urban infrastructure
                                        projects to innovative industrial solutions, our portfolio
                                        showcases a diverse range of successful endeavours. Each
                                        project exemplifies our commitment to excellence,
                                        innovation, and client satisfaction. Dive into our works and
                                        witness the transformative power of our solutions.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="complete-project-section">
                            <div className="project-container">
                                <div className="project-content">
                                    <p className="section-main-title project-page-title">
                                        Our Complete Project
                                    </p>
                                    <p className="hero-description service-description service-page-desc">
                                        At S M Service Consultancy, we take pride in our track
                                        record of successfully completed projects. Each endeavour
                                        represents a testament to our commitment to excellence and
                                        client satisfaction. Explore our portfolio of completed
                                        projects to see firsthand the impactful solutions we've
                                        delivered across various industries. From inception to
                                        execution, trust us to bring your vision to life.
                                    </p>
                                </div>
                            ...
                            <div className="project-container">
                                <div className="project-content">
                                    ...
                                    <p className="hero-description service-description service-page-desc">
                                        ...
                                        Illum eligendi illo explicabo voluptatem sapiente distinctio
                                        vel quasi voluptatibus est, animi nesciunt, temporibus
                                        tempore, quidem autem expedita. Sequi obcaecati ex soluta!
                                    </p>
                                </div>
                                <div className="gallery">
                                    <div className="grid">
