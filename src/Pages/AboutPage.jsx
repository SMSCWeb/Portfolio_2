        ...
        <div className="about-right-section">
          <div className="section-title text-left">
            ...
            <p className="hero-description">
              Our team comprises individuals who have honed their skills through
              years of hands-on experience, ensuring that every project we
              undertake benefits from a wealth of knowledge and a keen
              understanding of industry nuances. From intricate logistical
              challenges to strategic planning, we have navigated the
              complexities of various sectors with finesse, delivering results
              that exceed expectations time and again.
            </p>
          </div>
        </div>
      </section>
